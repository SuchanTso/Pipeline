MODEL="model/GAT_1000_huber.pt"
FigPath="GAT_1000_huber"
# python src/train/eval.py -m $MODEL -d "/data/zsc/Pipeline/data/epaNet/tt.inp" -p $FigPath -e 100 -l 10 --hours_analysis 72 > results/tt.log
...
python src/train/eval.py -m $MODEL -d "/data/zsc/Pipeline/data/epaNet/EPANET/example-networks/Net3.inp" -p $FigPath -e 100 -l 10 --hours_analysis 72 > results/Net3.log
