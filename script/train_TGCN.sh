...
# python src/train/train.py -m $MODEL -d "/data/zsc/Pipeline/data/epaNet/tt.inp" -e 100 -l 10 --hours_analysis 72
...
python src/train/train.py -m $MODEL -d "/data/zsc/Pipeline/data/epaNet/EPANET/example-networks/Net3.inp" -e 1000 -l 10 --hours_analysis 72
